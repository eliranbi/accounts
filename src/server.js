...
var _a = process.env, DB_USER = _a.DB_USER, DB_HOST = _a.DB_HOST, DB_DATABASE = _a.DB_DATABASE, DB_PASSWORD = _a.DB_PASSWORD, DB_PORT = _a.DB_PORT, WALLET_SERVICES_URL = _a.WALLET_SERVICES_URL;
...
server.post('/accounts', function (request, reply) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, accountId, accountName, rows, error_1, wallet, error_2, e_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                _a = request.body, accountId = _a.accountId, accountName = _a.accountName;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, client.query('SELECT * FROM accounts WHERE accountId = $1', [accountId])];
            ...
            case 6:
                ...
                return [4 /*yield*/, client.query("INSERT INTO accounts (accountId, accountName, walletId, address) VALUES ($1, $2, $3, $4)", [accountId, accountName, wallet.data.walletId, wallet.data.address])];
            case 7:
                // Execute a query to insert data into a table
                _b.sent();
                return [3 /*break*/, 9];
